...
export default async function WBPSubmissionsPage() {
    const submissions = await getSubmissionsByType('WBP');

    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight">WB&P Submissions</h1>
                <p className="text-muted-foreground">All Work Breakdown & Pricing submissions</p>
            </div>
                                        ...
                                        <div className="flex-1 space-y-2">
                                            ...
                                            {submission.documentRef && (
                                                <div className="text-sm text-muted-foreground">
                                                    Reference: <span className="font-medium">{submission.documentRef}</span>
                                                </div>
                                            )}
